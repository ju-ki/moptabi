...
const config = [
  ...
  },
  {
    ...
    rules: {
      '@typescript-eslint/no-explicit-any': 'warn', // anyを許可
      '@typescript-eslint/no-unused-vars': 'warn', // 未使用変数を許可
      'import/order': 'warn', // import/orderを無効化
      'no-console': 'warn', // console.logを許可
    },
  },
];
