...
import { OpeningHoursSchema, PlanSpotSchema, SpotMetaSchema, SpotSchema, SpotWithMetaSchema, TripSpotSchema } from './schema';
...
export type TripSpotType = z.infer<typeof TripSpotSchema>;